...
const OrderConfirmation: NextPage = () => {
  return (
    <ShopLayout1>
      <SEO title="Order Confirmation" description="Folo Studio là địa chỉ đặc biệt dành cho thiết kế website giá rẻ, tập trung vào việc xây dựng portfolio độc đáo, blog sáng tạo và trải nghiệm mua sắm trực tuyến đẳng cấp"/>
