  ...
  return (
    ...
    >
       <Box sx={{backgroundColor:'white'}} maxWidth="100%" mx="auto" mb="2.5rem" textAlign="center">
          ...
          <Typography sx={{maxWidth:'700px', mx:'auto', py:2}}>Trong thời đại công nghệ số, website là một công cụ không thể thiếu đối với bất kỳ doanh nghiệp nào. Một website được thiết kế đẹp mắt, chuyên nghiệp, đáp ứng đầy đủ nhu cầu của người dùng sẽ giúp doanh nghiệp nâng cao hình ảnh thương hiệu, tăng khả năng tiếp cận khách hàng và thúc đẩy doanh số bán hàng.</Typography>
        </Box>
